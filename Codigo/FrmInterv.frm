...
Private Sub Command2_Click()
    On Error GoTo Err
    'Intervalos
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "SanaIntervaloSinDescansar", CStr(SanaIntervaloSinDescansar))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "StaminaIntervaloSinDescansar", CStr(StaminaIntervaloSinDescansar))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "SanaIntervaloDescansar", CStr(SanaIntervaloDescansar))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "StaminaIntervaloDescansar", CStr(StaminaIntervaloDescansar))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloPerderStamina", CStr(IntervaloPerderStamina))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloSed", CStr(IntervaloSed))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloHambre", CStr(IntervaloHambre))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloVeneno", CStr(IntervaloVeneno))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloParalizado", CStr(IntervaloParalizado))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloInmovilizado", CStr(IntervaloInmovilizado))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloInvisible", CStr(IntervaloInvisible))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloFrio", CStr(IntervaloFrio))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloWAVFX", CStr(IntervaloWavFx))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "TimeoutPrimerPaquete", CStr(TimeoutPrimerPaquete))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "TimeoutEsperandoLoggear", CStr(TimeoutEsperandoLoggear))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloCaminar", CStr(IntervaloCaminar))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloTirar", CStr(IntervaloTirar))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloMeditar", CStr(IntervaloMeditar))
    '&&&&&&&&&&&&&&&&&&&&& TIMERS &&&&&&&&&&&&&&&&&&&&&&&
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloLanzaHechizo", CStr(IntervaloUserPuedeCastear))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloNpcAI", IntervaloNPCAI)
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloTrabajarExtraer", CStr(IntervaloTrabajarExtraer))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloTrabajarConstruir", CStr(IntervaloTrabajarConstruir))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloUserPuedeAtacar", CStr(IntervaloUserPuedeAtacar))
    Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloNpcOwner", CStr(IntervaloNpcOwner))
    'Call WriteVar(IniPath & "intervalos.ini", "INTERVALOS", "IntervaloPerdidaStaminaLluvia", frmMain.tLluvia.Interval)
